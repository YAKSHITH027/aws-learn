...
- **pre-commit**: Runs linting and TypeScript type checking before each commit
- **commit-msg**: Validates commit messages using conventional commit format
- **pre-push**: Runs the build command to ensure code builds successfully before pushing
